...
El objetivo de esta actividad es generar distintos modelos (LDA y Árboles de Decisión) para resolver un problema de clasificación y compararlos usando distintas métricas. Para ello se utilizará la base de datos **Spotify Tracks Dataset** del autor Maharshi Pandya, la cual se encuentra disponible en este [link](https://www.kaggle.com/datasets/maharshipandya/-spotify-tracks-dataset/data). De acuerdo con su descripción, el conjunto de datos incluye canciones de aproximadamente 125 géneros musicales, junto con diversas características relacionadas con sus propiedades de audio. El objetivo de este proyecto es determinar la **popularidad de una canción de pop** a partir de dichas características.
...
- [Reporte en formato ipynb](A2.2.ipynb)
- [Reporte en formato html](A2.2.html)
- [Base de datos](A2.2.csv)
